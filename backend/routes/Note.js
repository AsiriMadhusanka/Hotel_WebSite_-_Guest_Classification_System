...
const Enroll = require("../models/Note");
...
router.get("/mynote", async (req, res) => {
    try {
        const allMyNote = await Enroll.find(req.params);
        res.json(allMyNote);
...
//Get My Courses
router.get("/mynote/:userID", async (req, res) => {
    try {
        const allMyNote = await Enroll.find(req.params);
        res.json(allMyNote);
        console.log("result , ", allMyNote);
...
//Get specific enroll
router.get("/mynoteupdate/:id", async (req, res) => {
    try {
...
//Update enroll
router.put("/mynote/:id", async (req, res) => {
    try {
...
router.delete("/mynote/:id", async (req, res) => {
    try {
